...
// Bounding box limits for this node.
    private double minX, minY, minZ;
    private double maxX, maxY, maxZ;

// Child nodes for the tree.
    private BVHNode left;
    private BVHNode right;
// Objects stored when this is a leaf.
    private List<Object3D> objects;

// Maximum objects before splitting.
...
// Choose the widest axis to split.
...
// Find the closest hit inside this node.
...
// Check if this node blocks a shadow ray.
...
// Test if the ray hits the node box.
...
// Compute the box around these objects.
