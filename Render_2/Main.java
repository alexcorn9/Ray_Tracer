...
/**
 * NightRoad — protagonist POV with flashlight.
 *
 * RUBRIC COVERAGE:
 *  Shadows          — BVH shadow rays from all PointLights
 *  Blinn-Phong      — specular + shininess on car body and road surface
 *  Reflections ×2   — asphalt (0.30) reflects flashlight; car body (0.22) reflects road
 *  Refraction       — blinker glass (ior 1.45, transparency 0.15) on car taillights
 *  Light direction  — PointLight at camera + amber blinker PointLights cast correct shadows
 */
public class Main {

    public static void main(String[] args) {

        // ── Camera = protagonist eyes ─────────────────────────────────────────
        ...
        // Asphalt — reflectivity raised to 0.30 so entire road surface reflects
        ...
        // Car body — dark charcoal blue, Blinn-Phong specular, mild reflection
        ...
        // Blinker lens — bright amber, high ambient so it self-glows
        ...
        // ── Main flashlight (at camera/hand position) ────────────────────────
        // Warm amber torch light — sole primary illumination source.
        ...
        // Secondary spill — slightly ahead to light the road in front
        scene.addLight(new PointLight(
        ...
        // ── Car blinker lights (amber intermittents) ───────────────────────
        ...
        // Asphalt — now has reflectivity 0.30 for uniform road reflections
        ...
        // ── Road edge lines (continuous white stripes) ─────────────────────
        double eW = 0.10;
        ...
        // ── Blinker geometry (self-glowing amber quads on car rear) ───────
    ...
    /** Pine tree: two crossed billboard triangles. */
